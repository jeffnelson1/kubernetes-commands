...
cd ~/OneDrive\ -\ Centino\ Systems/Talks/Intro-Containers-Kubernetes/demos
...
#Demo 3 - Build the container in a private Azure Container Registry
az account set --subscription 'Demonstration Account'


#Create Resource Group for our Lab
LOCATION='centralus'
RESOURCEGROUP='IntroToContainers-k8s'
az group create --name $RESOURCEGROUP  --location $LOCATION
az group show --name $RESOURCEGROUP 
open https://portal.azure.com/#@nocentinohotmail.onmicrosoft.com/resource/subscriptions/fd0c5e48-eea6-4b37-a076-0e23e0df74cb/resourceGroups/IntroToContainers-k8s/overview
...
AKSCLUSTERNAME="AKS-IntroToContainers-k8s"
...
#Let's scale our application to 50 Pods...cuz why not?
